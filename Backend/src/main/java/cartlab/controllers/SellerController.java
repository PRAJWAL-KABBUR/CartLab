...
import cartlab.models.LoginDTO;
import cartlab.models.Response;
import cartlab.services.Email;
import cartlab.services.SellerService;
...
public class SellerController {
	...
	public ResponseEntity<?> save(@RequestBody Seller seller) {	
		Seller c=	sellerService.registerSeller(seller);
		if(c==null)
			return  Response.status(HttpStatus.NOT_FOUND);
		else
			email.simpleEmail(seller.getEmail(), "Welcome to E-Store of farming", "Registeration Complete");
