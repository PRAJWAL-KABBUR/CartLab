        ...
        <div className="container text-white">
            ...
            <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group form-row">
                        ...
                        <div className="col-sm-8">
                            <input type="email" readOnly name="email" value={user.email} onChange={handleInput} className="form-control" />                        
                        </div>
                    ...
                    <div className="form-group form-row">
                        ...
                        <div className="col-sm-8">
                            <input type="text" minLength="10" maxLength="10" name="phone" value={user.phone} onChange={handleInput} className="form-control" />                        
                        </div>
