        ...
        <div className="container-fluid text-white">
            ...
            <form onSubmit={handleSubmit} >           
                ...
                <div className="form-group form-row">
                    ...
                    <div className="col-sm-8">
                        <input type="text" name="zip" required value={address.zip} onChange={handleAddressInput} className="form-control" minLength="6" maxLength="6"/>                        
                    </div>                        
                </div>
                <div className="form-group form-row">
                ...
                <div className="form-group form-row">
                    ...
                    <div className="col-sm-8">
                        <input type="text" name="cardno" value={payment.cardno} onChange={handlePaymentInput} className="form-control" maxLength="16"minLength="16" required />                        
                    </div>                        
                </div>
                <div className="form-group form-row">
                ...
                <div className="form-group form-row">
                    ...
                    <div className="col-sm-8">
                        <input type="month" required className="form-control"   minLength="4" />                        
                    </div>                        
                </div>
                <div className="form-group form-row">
                    <label className="col-sm-4 form-control-label">CVV</label>
                    <div className="col-sm-8">
                        <input type="text" maxLength="3" minLength="3" value={payment.cvv} onChange={handlePaymentInput} className="form-control"  required/>                        
                    </div>                        
                </div>
                <div className="form-group form-row">
