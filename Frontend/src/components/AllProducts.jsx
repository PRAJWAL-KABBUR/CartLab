    ...
    const addToCart=item=>{  
        if(sessionStorage.getItem("email")==null){
            ...
            {     
                ...
                setDisplay("none")
                setShowDialog("modal fade") 
                let index = state.cart.findIndex(x=>x.prodid===item.prodid);                
                let currentQuantity=state.cart[index].qty;
                state.cart[index].qty = parseInt(currentQuantity)+parseInt(qty);
